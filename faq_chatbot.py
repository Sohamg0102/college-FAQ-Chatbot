...
st.markdown("#### 🧾 Answer:")
st.write(faq_data[category][question])

st.markdown("---")
st.markdown("### 💬 Or Ask Your Own Question Below")

# Prepare for chatbot search
flat_questions = []
flat_answers = []
...
st.markdown("---")
st.caption("Made  by Soham Gaikwad | BSc Data Science & AI | Dept. of Technology, SSPU")